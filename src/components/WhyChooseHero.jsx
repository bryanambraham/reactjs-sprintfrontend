...
const WhyChooseHero = ({ className = "" }) => {
  return (
    <section className={`relative bg-[#FF6600] overflow-hidden py-12 ${className}`}>
      {/* Background circles */}
      ...
      <div className="container mx-auto px-4 relative">
        <div className="max-w-3xl mx-auto">
          {/* Title */}
          <h2 className="text-2xl md:text-3xl font-bold bg-[#1B1464] text-white p-4 mb-8">
            Kenapa Harus Pilih Cargonesia?
          </h2>
          <hr className="border-t-4 mt-[-20] max-w-lg" />
          {/* Benefits List */}
