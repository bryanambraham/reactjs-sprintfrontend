...
function Badung() {
  ...
  const descriptionItemsBot = [
    {
      content: [
        "Ekspedisi Jakarta ke Badung – Sprint Cargo menyediakan layanan pengiriman barang dari Jakarta ke Badung dengan layanan cepat, aman, dan tarif terjangkau. Dengan pengalaman bertahun-tahun di industri logistik, kami menjadi pilihan utama untuk ekspedisi ke pusat pariwisata Bali ini.",
        "Proses pengiriman ke Badung dilakukan melalui jalur darat dan laut, dengan armada trucking yang efisien dari Jakarta menuju Pelabuhan Ketapang, dilanjutkan dengan kapal ferry ke Pelabuhan Gilimanuk, dan akhirnya ke Badung. Estimasi waktu pengiriman adalah 3-4 hari. Kami melayani pengiriman ke seluruh area Badung, termasuk Kuta, Seminyak, Canggu, Jimbaran, Nusa Dua, dan sekitarnya.",
        "Pengiriman dilakukan dari Jakarta menuju hub distribusi di Bali sebelum diteruskan ke alamat penerima di Badung. Sprint Cargo memastikan setiap pengiriman dilakukan dengan prosedur standar dan melewati tahap sortir untuk menjaga ketepatan dan keamanan barang.",
      ],
    },
  ]
  ...
  const descriptionItems = [
    {
      title: "Jasa Pengiriman Barang ke Badung Terbaik Pilihan Pelanggan",
      content: [
        "Sprint Cargo adalah pilihan terbaik untuk jasa ekspedisi dari Jakarta ke Badung dengan layanan profesional, tarif kompetitif, dan jaminan keamanan barang.",
        ...
        "Dengan jaringan distribusi yang luas, kami melayani pengiriman ke seluruh wilayah Badung, termasuk area wisata, kawasan hotel, dan perumahan.",
      ],
    },
    {
      title: "Rute Ekspedisi Jakarta ke Badung",
      content: [
        "Pengiriman dari Jakarta ke Badung menggunakan kombinasi jalur darat dan laut. Barang dikirim dari Jakarta menuju Pelabuhan Ketapang (Banyuwangi) menggunakan truk, kemudian menyeberang ke Pelabuhan Gilimanuk menggunakan kapal ferry, dan dilanjutkan ke Badung.",
        "Barang dikirim dari Jakarta menuju hub distribusi di Bali sebelum didistribusikan ke alamat penerima di berbagai lokasi di Badung seperti Kuta, Seminyak, Canggu, Jimbaran, Nusa Dua, dan area lainnya.",
    ...
    {
      title: "Jasa Ekspedisi Cargo Laut ke Badung",
      content: [
        "Sprint Cargo menyediakan layanan cargo laut untuk pengiriman barang dari Jakarta ke Badung dengan harga terjangkau dan pengiriman tepat waktu.",
    ...
    {
      title: "Jasa Ekspedisi Cargo Udara ke Badung",
      content: [
        "Bagi pelanggan yang membutuhkan pengiriman cepat, Sprint Cargo menyediakan layanan cargo udara dari Jakarta ke Bandara Ngurah Rai, dilanjutkan dengan pengiriman darat ke Badung.",
    ...
    {
      title: "Keunggulan Menggunakan Jasa Ekspedisi Sprint Cargo ke Badung",
      content: [
    ...
    {
      title: "Jenis Barang yang Sering Dikirim ke Badung",
      content: ["Sprint Cargo melayani pengiriman berbagai jenis barang dari Jakarta ke Badung, termasuk:"],
      list: [
  ...
  return (
    <div className="min-h-screen bg-secondary">
      <HeroSection
        title="Jasa Ekspedisi Jakarta ke Badung Cepat dan Terpercaya"
        description="Sprint Cargo siap mengirim barang dari Jakarta ke Badung dengan layanan aman, cepat, dan harga terjangkau. Estimasi pengiriman 3-4 hari dengan jaminan barang sampai dengan aman."
        button={{
