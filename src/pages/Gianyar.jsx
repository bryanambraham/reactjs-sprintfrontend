...
function Gianyar() {
  ...
  const descriptionItemsBot = [
    {
      content: [
        "Ekspedisi Jakarta ke Gianyar – Sprint Cargo menyediakan layanan pengiriman barang dari Jakarta ke Gianyar dengan layanan cepat, aman, dan tarif terjangkau. Dengan pengalaman bertahun-tahun di industri logistik, kami menjadi pilihan utama untuk ekspedisi ke pusat seni dan kerajinan Bali ini.",
        "Proses pengiriman ke Gianyar dilakukan melalui jalur darat dan laut, dengan armada trucking yang efisien dari Jakarta menuju Pelabuhan Ketapang, dilanjutkan dengan kapal ferry ke Pelabuhan Gilimanuk, dan akhirnya ke Gianyar. Estimasi waktu pengiriman adalah 3-4 hari. Kami melayani pengiriman ke seluruh area Gianyar, termasuk Ubud, Sukawati, Tegallalang, dan sekitarnya.",
        "Pengiriman dilakukan dari Jakarta menuju hub distribusi di Bali sebelum diteruskan ke alamat penerima di Gianyar. Sprint Cargo memastikan setiap pengiriman dilakukan dengan prosedur standar dan melewati tahap sortir untuk menjaga ketepatan dan keamanan barang.",
      ],
    },
  ]
  ...
  const descriptionItems = [
    {
      title: "Jasa Pengiriman Barang ke Gianyar Terbaik Pilihan Pelanggan",
      content: [
        "Sprint Cargo adalah pilihan terbaik untuk jasa ekspedisi dari Jakarta ke Gianyar dengan layanan profesional, tarif kompetitif, dan jaminan keamanan barang.",
        ...
        "Dengan jaringan distribusi yang luas, kami melayani pengiriman ke seluruh wilayah Gianyar, termasuk area wisata, sentra kerajinan, dan pedesaan.",
      ],
    },
    {
      title: "Rute Ekspedisi Jakarta ke Gianyar",
      content: [
        "Pengiriman dari Jakarta ke Gianyar menggunakan kombinasi jalur darat dan laut. Barang dikirim dari Jakarta menuju Pelabuhan Ketapang (Banyuwangi) menggunakan truk, kemudian menyeberang ke Pelabuhan Gilimanuk menggunakan kapal ferry, dan dilanjutkan ke Gianyar.",
        "Barang dikirim dari Jakarta menuju hub distribusi di Bali sebelum didistribusikan ke alamat penerima di berbagai lokasi di Gianyar seperti Ubud, Sukawati, Tegallalang, Batubulan, dan area lainnya.",
    ...
    {
      title: "Jasa Ekspedisi Cargo Laut ke Gianyar",
      content: [
        "Sprint Cargo menyediakan layanan cargo laut untuk pengiriman barang dari Jakarta ke Gianyar dengan harga terjangkau dan pengiriman tepat waktu.",
    ...
    {
      title: "Jasa Ekspedisi Cargo Udara ke Gianyar",
      content: [
        "Bagi pelanggan yang membutuhkan pengiriman cepat, Sprint Cargo menyediakan layanan cargo udara dari Jakarta ke Bandara Ngurah Rai, dilanjutkan dengan pengiriman darat ke Gianyar.",
    ...
    {
      title: "Keunggulan Menggunakan Jasa Ekspedisi Sprint Cargo ke Gianyar",
      content: [
    ...
    {
      title: "Jenis Barang yang Sering Dikirim ke Gianyar",
      content: ["Sprint Cargo melayani pengiriman berbagai jenis barang dari Jakarta ke Gianyar, termasuk:"],
      list: [
        "Bahan baku kerajinan dan seni",
  ...
  return (
    <div className="min-h-screen bg-secondary">
      <HeroSection
        title="Jasa Ekspedisi Jakarta ke Gianyar Cepat dan Terpercaya"
        description="Sprint Cargo siap mengirim barang dari Jakarta ke Gianyar dengan layanan aman, cepat, dan harga terjangkau. Estimasi pengiriman 3-4 hari dengan jaminan barang sampai dengan aman."
        button={{
