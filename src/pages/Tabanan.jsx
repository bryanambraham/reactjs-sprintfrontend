...
function Tabanan() {
  ...
  const descriptionItemsBot = [
    {
      content: [
        'Ekspedisi Jakarta ke Tabanan – Sprint Cargo menyediakan layanan pengiriman barang dari Jakarta ke Tabanan dengan layanan cepat, aman, dan tarif terjangkau. Dengan pengalaman bertahun-tahun di industri logistik, kami menjadi pilihan utama untuk ekspedisi ke daerah pertanian dan wisata alam Bali ini.",  kami menjadi pilihan utama untuk ekspedisi ke daerah pertanian dan wisata alam Bali ini.',
        "Proses pengiriman ke Tabanan dilakukan melalui jalur darat dan laut, dengan armada trucking yang efisien dari Jakarta menuju Pelabuhan Ketapang, dilanjutkan dengan kapal ferry ke Pelabuhan Gilimanuk, dan akhirnya ke Tabanan. Estimasi waktu pengiriman adalah 3-4 hari. Kami melayani pengiriman ke seluruh area Tabanan, termasuk Kediri, Kerambitan, Selemadeg, dan sekitarnya.",
        "Pengiriman dilakukan dari Jakarta menuju hub distribusi di Bali sebelum diteruskan ke alamat penerima di Tabanan. Sprint Cargo memastikan setiap pengiriman dilakukan dengan prosedur standar dan melewati tahap sortir untuk menjaga ketepatan dan keamanan barang.",
      ],
    },
  ]
  ...
  const descriptionItems = [
    {
      title: "Jasa Pengiriman Barang ke Tabanan Terbaik Pilihan Pelanggan",
      content: [
        "Sprint Cargo adalah pilihan terbaik untuk jasa ekspedisi dari Jakarta ke Tabanan dengan layanan profesional, tarif kompetitif, dan jaminan keamanan barang.",
        ...
        "Dengan jaringan distribusi yang luas, kami melayani pengiriman ke seluruh wilayah Tabanan, termasuk area pertanian, wisata alam, dan pedesaan.",
      ],
    },
    {
      title: "Rute Ekspedisi Jakarta ke Tabanan",
      content: [
        "Pengiriman dari Jakarta ke Tabanan menggunakan kombinasi jalur darat dan laut. Barang dikirim dari Jakarta menuju Pelabuhan Ketapang (Banyuwangi) menggunakan truk, kemudian menyeberang ke Pelabuhan Gilimanuk menggunakan kapal ferry, dan dilanjutkan ke Tabanan.",
        "Barang dikirim dari Jakarta menuju hub distribusi di Bali sebelum didistribusikan ke alamat penerima di berbagai lokasi di Tabanan seperti Kediri, Kerambitan, Selemadeg, Penebel, dan area lainnya.",
    ...
    {
      title: "Jasa Ekspedisi Cargo Laut ke Tabanan",
      content: [
        "Sprint Cargo menyediakan layanan cargo laut untuk pengiriman barang dari Jakarta ke Tabanan dengan harga terjangkau dan pengiriman tepat waktu.",
    ...
    {
      title: "Jasa Ekspedisi Cargo Udara ke Tabanan",
      content: [
        "Bagi pelanggan yang membutuhkan pengiriman cepat, Sprint Cargo menyediakan layanan cargo udara dari Jakarta ke Bandara Ngurah Rai, dilanjutkan dengan pengiriman darat ke Tabanan.",
    ...
    {
      title: "Keunggulan Menggunakan Jasa Ekspedisi Sprint Cargo ke Tabanan",
      content: [
    ...
    {
      title: "Jenis Barang yang Sering Dikirim ke Tabanan",
      content: ["Sprint Cargo melayani pengiriman berbagai jenis barang dari Jakarta ke Tabanan, termasuk:"],
      list: [
        "Peralatan pertanian dan perkebunan",
  ...
  return (
    <div className="min-h-screen bg-secondary">
      <HeroSection
        title="Jasa Ekspedisi Jakarta ke Tabanan Cepat dan Terpercaya"
        description="Sprint Cargo siap mengirim barang dari Jakarta ke Tabanan dengan layanan aman, cepat, dan harga terjangkau. Estimasi pengiriman 3-4 hari dengan jaminan barang sampai dengan aman."
        button={{
